...
const dbWrapper = {
  ...
  sort: {
    department: {style: 'name', invert: false},
    role: {style: 'deptFirst', invert: false},
    employee: {style: 'deptFirst', invert: false},
  },
  // error "handling"
  ...
  get(type, column, selector = '') {
    ...
    query.append(QUERY.order[type][this.sort[type].style](this.sort[type].invert));
