module.exports = (dbWrapper, titleCase) => {
  return {
    choices: [
    ...
    questions: {
      ...
      role: [
        ...
        },
        {
          ...
          type: 'number',
          default: 15080.0,
          transformer: (input) => input.toLocaleString('en-US', {style: 'currency', currency: 'USD'}),
          validate: (val) =>
      ...
      employee: [
        ...
        },
        {
          ...
          type: 'input',
          // not using titleCase here to avoid de-capitalizing last names like "McDonald"
          filter: (str) =>
            str
              .split(' ')
